...
* #### Dictionary Attributes
  ...
  1. Added `criticality_id` enum to `resource_details` to pair with its sibling. [#]()
...
* #### Objects
  ...
  1. Added `device` and `user` to `resource_details`. Added a `criticality_id` enum to `resource_details` to pair with its sibling. [#]()
* #### Observables
* #### Platform Extensions
