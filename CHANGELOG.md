...
* #### Event Classes
    ...
    1. Added attributes and a new Activity ID to the `File Hosting Activity` class for network file share services and authorization check result. Activity ID added: `17` - "Access Check". Optional `context` group attributes added: `access_mask`, `access_result`, `share`, `share_type`, and `share_type_id`. #1297
* #### Profiles
