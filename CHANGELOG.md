...
* #### Dictionary Attributes
  ...
  1. Added `clipboard_binary_data`, `clipboard_items`, `clipboard_mime_type`, `clipboard_native_type`, `clipboard_string_data`. [#TBD](https://github.com/ocsf/ocsf-schema/pull/TBD)
