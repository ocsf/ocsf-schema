...
* #### Event Classes
  ...
  1. Extended `activity_id` attribute in `HTTP Activity` to cover WebDAV HTTP methods. [#1654](https://github.com/ocsf/ocsf-schema/pull/1654)
* #### Profiles
* #### Objects
  ...
  1. Extended `http_method` attribute in the `http_request` object to cover WebDAV HTTP methods. [#1654](https://github.com/ocsf/ocsf-schema/pull/1654)
### Deprecated
