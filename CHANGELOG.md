...
* #### Dictionary Attributes
  ...
  1. Added `execute_privilege_count` integer attribute for count of execute-type privileges. [#1581](https://github.com/ocsf/ocsf-schema/pull/1581)
  ...
  1. Added `read_privilege_count` integer attribute for count of read-type privileges. [#1581](https://github.com/ocsf/ocsf-schema/pull/1581)
  ...
  1. Added `write_privilege_count` integer attribute for count of write-type privileges. [#1581](https://github.com/ocsf/ocsf-schema/pull/1581)
