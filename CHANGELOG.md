...
* #### Objects
  ...
  1. Added `motw_object` object to describe the Mark of the Web metadata of a `file` in the Windows extension. [#1999](https://github.com/ocsf/ocsf-schema/pull/1999)
* #### Observables
* #### Platform Extensions
* #### Dictionary Attributes
  ...
  1. Added `motw` attribute to `file` object in Windows extension. [#1999](https://github.com/ocsf/ocsf-schema/pull/1999)
