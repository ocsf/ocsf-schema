...
* #### Dictionary Attributes
  ...
  1. Added `criticality_id` enum to pair with its sibling. [#1693](https://github.com/ocsf/ocsf-schema/pull/1693)
...
* #### Objects
  ...
  1. Added `device` and `user` to `resource_details`. Added a `criticality_id` enum to `resource_details` to pair with its sibling. [#1693](https://github.com/ocsf/ocsf-schema/pull/1693)
* #### Observables
* #### Platform Extensions
